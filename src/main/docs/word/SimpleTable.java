...
public class SimpleTable {
	...
	private static String OUTPATH = "/home/dothr/Documents/Tmp/styledTable.docx";
    ...
    public static void createSimpleTable() throws Exception {
        ...
        try {
            ...
            table.getRow(1).getCell(1).setText("EJEMPLO DE TABLA");
        ...
        try {
            ...
            for (XWPFTableRow row : rows) {
                ...
                for (XWPFTableCell cell : cells) {
                    ...
                    if (rowCt == 0) {
                        // header row
                        rh.setText("Fila encabezado row, col " + colCt);
                        rh.setBold(true);
                        para.setAlignment(ParagraphAlignment.CENTER);
                    } else {
                        // other rows
                        rh.setText("fila " + rowCt + ", columna " + colCt);
