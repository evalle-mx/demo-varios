...
public abstract class Mensaje {
	...
	public final static String MSG_FASES_DIAS_SECUENCIAL="La asignación de dias debe ser secuencial por orden y actividad";
	public final static String MSG_HAY_POSTULANTES="la Fase del Modelo_RSC_Pos ya que existen postulantes(candidatos confirmados)";
	public final static String MSG_EXISTEN_PERSONA_ROL = "Existen usuarios relacionados al Rol, es requerido modificar";
	...
	// El objeto ya fue válidado
	public final static String SERVICE_CODE_015="015";
	// El objeto ya existe
	public final static String SERVICE_CODE_016="016";
	// El objeto no se puede eliminar
	public final static String SERVICE_CODE_017="017";
	// El objeto no se puede crear
	public final static String SERVICE_CODE_018="018";
	...
	// Sobre la conectividad con otros APPzz
	...
	public final static String SERVICE_MSG_ERROR_UPLOAD_TYPE="El tipo de archivo no es el correcto para este contenido";
